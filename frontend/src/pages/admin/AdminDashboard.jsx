            ...
            <div style={{ animation: 'fadeIn 0.5s ease-out' }}>
                ...
                <main className="sd-grid">
                    ...
                    <section className="sd-card">
                        <div className="sd-card-header">
                            <div className="sd-card-header-left">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--sd-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
                                <h2>Communications</h2>
                            </div>
                        </div>
                        <p style={{ fontSize: '14px', color: 'var(--sd-text-secondary)', marginBottom: '16px', lineHeight: '1.5' }}>
                            Broadcast announcements and notifications to specific roles or batches directly to their dashboards.
                        </p>
                        <button onClick={() => navigate('/admin/notifications/create')} className="sd-btn-primary" style={{ width: '100%' }}>
                            Send Notification
                        </button>
                    </section>
                </main>
